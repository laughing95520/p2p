...
public class InvestAdminController {
    ...
    public void returnMoneyToUser(@RequestParam("id")String id){
        try{
            ...
            double income = new BigDecimal(p2pInvest.getIid()).setScale(2).doubleValue();
            customerService.addInvestMoney(allMoney,income,p2pInvest.getUid());
        }catch (Exception e){
